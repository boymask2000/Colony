...
public class EdificioSuArea extends EdificioFabbrica implements NotifyFromAgent{
	private int timeToWork = 15;
	private long lastTimeWorked = 0;
	private boolean missionComplete = true;
	protected float sizeArea = 300;

	public EdificioSuArea(float x, float y, Stage s, BaseActor act,String name) {
